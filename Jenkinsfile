pipeline {
    ...
    environment {
        ...
        GIT_REPO = 'https://github.com/akhilreddy1420/cicdhtml' // Your GitHub repo URL
    ...
    stages {
        ...
        stage('SonarQube Analysis') {
            steps {
                ...
                script {
                    sh 'sonar-scanner -Dsonar.projectKey=your_project_key -Dsonar.host.url=http://54.145.242.147:9000 -Dsonar.sources=.'
                }
            }
        }
